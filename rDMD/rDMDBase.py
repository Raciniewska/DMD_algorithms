...
from rDMD.rDMDOperator import rDMDOperator

from functools import partial


class rDMDBase(object):
    """
    ...
    class ModesSelectors:
        ...
        def stable_modes(max_distance_from_unity):
            ...
            """
            return partial(
                rDMDBase.ModesSelectors._stable_modes,
        ...
        def _integral_contribution(dmd, n):
            ...
            integral_contributions = [
                rDMDBase.ModesSelectors._compute_integral_contribution(*tp)
        ...
        def integral_contribution(n):
            ...
            """
            return partial(rDMDBase.ModesSelectors._integral_contribution, n=n)
